...
public class Dealer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 250, -1, -1));
        ...
        jPanel1.add(fname, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 250, 220, -1));
        ...
        tp2.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                tp2KeyTyped(evt);
            }
        });
        jPanel1.add(tp2, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 340, 220, -1));

        jLabel5.setFont(new java.awt.Font("Tahoma", 0, 15)); // NOI18N
        jLabel5.setText("Telephone 2");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 340, -1, -1));
        ...
        jPanel1.add(add, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 420, 300, -1));
        ...
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(1140, 340, -1, -1));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NIC", "First Name", "Second Name", "Telephone 1", "Telephone 2", "Email", "Address", "Registered Date", "Description"
            }
        ) {
        ...
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(1140, 420, -1, -1));
        ...
        jPanel1.add(dis, new org.netbeans.lib.awtextra.AbsoluteConstraints(1270, 420, 320, -1));

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        jLabel1.setText("Dealers ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            DB_connection.iud("insert into dealer (D_ID, F_Name, L_Name, M_No, M_No2, Email, Address, Date_Of_Reg, Description) values ('" + nic.getText() + "" + "', '" + fname.getText() + "', '" + lname.getText() + "', '" + Integer.parseInt(tp1.getText()) + "', '" + Integer.parseInt(tp2.getText()) + "', '" + em.getText() + "', '" + add.getText() + "', '" + date.getText() + "', '" + dis.getText() + "')");
            clearall();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            DB_connection.iud("delete from dealer where D_ID = '" + nic.getText() + "'");
            clearall();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            DB_connection.iud("Update dealer set F_Name = '"+fname.getText()+"', L_Name = '"+lname.getText()+"', M_No = '"+tp1.getText()+"', M_No2 = '"+tp2.getText()+"', Email = '"+em.getText()+"', Address = '"+add.getText()+"', Description = '"+dis.getText()+"' where D_ID = '"+nic.getText()+"'");
            clearall();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        tp2.setText((String) jTable1.getValueAt(i, 4));
        em.setText((String) jTable1.getValueAt(i, 5));
        add.setText((String) jTable1.getValueAt(i, 6));
        dis.setText((String) jTable1.getValueAt(i, 8));
    ...
    private void nicKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_nicKeyReleased
        try {
            if (evt.getKeyCode() == KeyEvent.VK_DOWN) {
                ...
                ResultSet rs = DB_connection.search("select * from dealer where D_ID like '%" + nic.getText() + "%'");
                Vector v = new Vector();
                while (rs.next()) {
    ...
    private void tp2KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tp2KeyTyped
         char c = evt.getKeyChar();
        if (Character.isDigit(c)) {
        } else {
            evt.consume();
        }
    }//GEN-LAST:event_tp2KeyTyped
    ...
    private void loadsup() {
        ...
        try {
            ...
            ResultSet sr = DB_connection.search("select * from dealer");

            while (sr.next()) {
                Vector v = new Vector();
                v.add(sr.getString("D_ID"));
                v.add(sr.getString("F_Name"));
                v.add(sr.getString("L_Name"));
                v.add(sr.getString("M_No"));
                v.add(sr.getString("M_No2"));
    ...
    private void search() {
        try {
            ResultSet rs = DB_connection.search("select * from dealer where D_ID = '" + nic.getText() + "'");
            while (rs.next()) {
                fname.setText(rs.getString("F_Name"));
                lname.setText(rs.getString("L_Name"));
                tp1.setText(rs.getString("M_No"));
                tp2.setText(rs.getString("M_No2"));
